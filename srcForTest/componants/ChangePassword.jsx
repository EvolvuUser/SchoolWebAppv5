...
//     >
//       <NavBar />
//       <div className=" sm:container lg:w-[50%] lg:h-[80%] box-border mx-auto p-4 pt-6   bg-white ">
...
//               className="outline border-none bg-gray-100 inset-4  p-2 pl-10 text-sm mb-2 text-gray-700"
//             />
//             {errors.motherName && (
...
//             Password can be 8 to 20 characters long, must contain a number and a
...
//       <NavBar />
//       <LoadingSpinner />
//       <div className="sm:container lg:w-[40%]  lg:h-auto box-border mx-auto p-4 pt-6 mt-10 lg:mt-2 mb-4 bg-white">
...
//           <button
//             type="submit"
//             className="W-10 relative left-[70%] lg:left-[83%] bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-2"
//           >
//             Update
